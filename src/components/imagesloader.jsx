...
const custom_made_flower_wallpaper_loader = new assetsloader(custom_made_flower_wallpaper, 679, 482)
...
export {flowers_loader, garland_loader, background_loader, wallpaper_loader, flower_wallpaper_loader, custom_made_flower_wallpaper_loader, rose_chain_loader, button_flower_loader}