  ...
  return (
    <>
      <div
        ...
        ref={containerRef}
      >
          <div className={"w-fit h-fit relative max-[805px]:w-screen observe " + (isVisible ? "to_original" : "to_left")}>
            <Image
      ...
      <div className={"flex max-[1495px]:hidden w-full bg-tertiary-1100 justify-center items-center relative observe " + (isVisible ? "to_original" : "blur")}>
        <Image
          src={background_loader.getAsset()}
          alt={"background wallpaper landscape"}
          width={background_loader.getWidth()}
