    ...
    <>
      <div className="w-screen h-screen bg-primary overflow-hidden max-[1226px]:overflow-y-scroll flex-col">
        ...
        <div className="flex h-full relative justify-between max-[1226px]:flex-col">
          <div
            className="h-fit w-fit border-r-[16px] border-tertiary-1100"
          ...
          <div
            className="absolute flex justify-center bottom-0 w-screen max-[1226px]:relative max-[609px]:bg-tertiary-900 max-[609px]:h-fit"
            id="footer_banner"
          >
            ...
            <div
              className="absolute w-[807px] h-[532px] p-2 max-[832px]:scale-[.8] max-[832px]:-translate-x-[28px] max-[832px]:-translate-y-[40px] max-[740px]:-translate-x-14 max-[740px]:-translate-y-20 max-[740px]:scale-[.65] max-[748px]:-translate-x-[40px] max-[703px]:scale-[.65] max-[703px]:-translate-x-7 max-[703px]:-translate-y-[75px] max-[670px]:-translate-y-[76px] max-[663px]:translate-x-0 max-[663px]:-translate-y-[450px] max-[663px]:w-full max-[663px]:flex max-[663px]:items-center max-[663px]:justify-center max-[663px]:bg-secondary-900 max-[663px]:h-[400px] max-[663px]:rounded-full max-[663px]:bg-opacity-60 max-[663px]:z-0 max-[609px]:hidden rounded-l-[200px]"
              onMouseEnter={() => setF2(3)}
              onMouseLeave={() => setF2(1)}
            >
              <DistortionEffect img_loader={flower_loader} factor={f2} />
            </div>
            ...
            <div className="absolute lowercase font-serif_i text-[19px] text-secondary-800 w-[500px] leading-[22px] ml-[200px] top-[8px] max-[832px]:-translate-x-2 max-[792px]:leading-5 max-[781px]:text-[16px] max-[748px]:translate-x-[-10px] max-[748px]:leading-[20px] max-[741px]:leading-[17px] max-[709px]:leading-4 max-[703px]:w-[450px] max-[703px]:-translate-y-1 max-[670px]:translate-x-[-40px] max-[670px]:leading-[16px] max-[670px]:w-[400px] max-[663px]:m-0 max-[663px]:translate-x-0 max-[663px]:w-[300px] max-[663px]:translate-y-[-90px] max-[609px]:leading-5 max-[609px]:w-full max-[609px]:static max-[609px]:translate-y-0 max-[663px]:z-10">
              ...
              <div
                className="hidden border-b-4 m-1 p-1 border-dotted max-[747px]:border-b-2 max-[609px]:flex font-black uppercase justify-center"
                onMouseEnter={() => setF2(3)}
                onMouseLeave={() => setF2(1)}
              >
                <DistortionEffect img_loader={flower_loader} factor={f2} />
              ...
              <div className="hidden text-secondary-800 border-b-4 m-1 p-1 border-dotted text-end max-[781px]:block max-[832px]:border-b-2">
