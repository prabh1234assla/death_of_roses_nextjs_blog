...
export function Model({model_url, model_ref}) {
  ...
  return (
    <group ref={model_ref} dispose={null} scale={0.18} position={[0, -1.45, -1]}>
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.027}>
        ...
        <mesh geometry={nodes['1Newplan_5'].geometry} material={materials['1Newplan_1InfInt']} />
        <mesh geometry={nodes['1Newplan_6'].geometry} material={materials['1Newplan_1Pdcel']} />
        <mesh geometry={nodes['1Newplan_7'].geometry} material={materials['1Newplan_FruitR']} />
      </group>
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.027}>
        ...
        <mesh geometry={nodes['1Newplan001_5'].geometry} material={materials['1Newplan_1InfInt']} />
        <mesh geometry={nodes['1Newplan001_6'].geometry} material={materials['1Newplan_1Pdcel']} />
        <mesh geometry={nodes['1Newplan001_7'].geometry} material={materials['1Newplan_FruitR']} />
      </group>
    </group>
  )
}
